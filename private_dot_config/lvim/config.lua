...
lvim.builtin.which_key.mappings["ss"] = { function()
  require('telescope.builtin').live_grep({ cwd = vim.fn.expand('%:p:h'):gsub('oil://', '') })
end, "Text (Local)" }
...
lvim.plugins = {
  ...
  --   "aduros/ai.vim",
  --   config = function()
  --     vim.api.nvim_set_keymap("n", "<leader>ai", ":AI ", { noremap = true })
  --     vim.api.nvim_set_keymap("v", "<leader>ai", ":AI ", { noremap = true })
  --     vim.api.nvim_set_keymap("i", "<leader>ai", "<Esc>:AI<CR>a", { noremap = true })
  --   end,
  -- },
}
